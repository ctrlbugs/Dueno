  ...
  return (
	...
	========================= */}
      <div className="page-wrapper">
        <Breadcrumb
          title="Agency List"
          paths={[{ label: "Agency List", active: true }]}
        />
          ...
          <div className="container">
            ...
            <div className="agent-list-item">
              ...
              <div className="agent-content">
                ...
                <div className="border-bottom mb-3 pb-3">
                  <p className="mb-0">
                    We offer a free, data-driven property valuation to help you
                    price it right from day one—no guesswork.
                  </p>
                </div>
            ...
            <div className="agent-list-item">
              ...
              <div className="agent-content">
                ...
                <div className="border-bottom mb-3 pb-3">
                  <p className="mb-0">
                    From high-quality photography and video tours to listings on
                    top portals and social media—your property gets maximum
                    exposure.
                  </p>
                </div>
                <div className="social-icons">
            ...
            <div className="agent-list-item">
              ...
              <div className="agent-content">
                ...
                <div className="d-flex align-items-center justify-content-between mb-3">
                  <div>
                    <h5 className="mb-1">
                      <Link to={all_routes.agencyDetails}>Luxurious Estate</Link>
                    </h5>
                    <p className="mb-0 d-inline-flex align-items-center">
                ...
                <div className="border-bottom mb-3 pb-3">
                  <p className="mb-0">
                    We know the neighborhoods, trends, and buyer behavior—so we
                    market your home with precision.
                  </p>
                </div>
                <div className="social-icons">
                  <Link to="#">
            ...
            <div className="agent-list-item">
              ...
              <div className="agent-content">
                ...
                <div className="border-bottom mb-3 pb-3">
                  <p className="mb-0">
                    Our skilled agents negotiate on your behalf to ensure you
                    get the best possible deal—fast and hassle-free.
                  </p>
                </div>
                <div className="social-icons">
                  <Link to="#">
            ...
            <div className="agent-list-item">
              ...
              <div className="agent-content">
                ...
                <div className="border-bottom mb-3 pb-3">
                  <p className="mb-0">
                    We handle the paperwork, title checks, and compliance to
                    protect you from any legal pitfalls.
                  </p>
                </div>
                <div className="social-icons">
                  <Link to="#">
            ...
            <div className="agent-list-item">
              ...
              <div className="agent-content">
                ...
                <div className="border-bottom mb-3 pb-3">
                  <p className="mb-0">
                    No time-wasters. We pre-screen every potential buyer to
                    ensure they’re financially ready and serious.
                  </p>
                </div>
                <div className="social-icons">
                  <Link to="#">
            ...
            <div className="agent-list-item">
              ...
              <div className="agent-content">
                ...
                <div className="border-bottom mb-3 pb-3">
                  <p className="mb-0">
                    You’ll never be left wondering—we keep you in the loop with
                    regular updates on viewings, offers, and market feedback.
                  </p>
                </div>
                <div className="social-icons">
                  <Link to="#">
            ...
            <div className="agent-list-item">
              ...
              <div className="agent-content">
                ...
                <div className="border-bottom mb-3 pb-3">
                  <p className="mb-0">
                    Our proven process and wide buyer network help you sell
                    quickly—often above market average timeframes.
                  </p>
                </div>
                <div className="social-icons">
                  <Link to="#">
