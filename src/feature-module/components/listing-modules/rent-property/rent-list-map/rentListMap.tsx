...
import BuyRightMap from "../../buy-property/buy-grid-map/buyRightMap";
  ...
  return (
    <>
      ...
      <div className="page-wrapper">
        ...
        <Breadcrumb
          title="Rent List Map"
          paths={[{ label: "Rent List Map", active: true }]}
        />
        {/* End Breadscrumb */}
        {/* Start Content */}
                  ...
                  <div className="card-body">
                    ...
                    <form>
                      ...
                      <div className="d-flex align-items-center justify-content-end gap-2">
                        <Link to="#" className="btn btn-dark fw-normal">
                          Reset
                        </Link>
                        <Link to="#" className="btn btn-primary fw-normal">
                          Apply Filter
                        </Link>
                      </div>
                    </form>
